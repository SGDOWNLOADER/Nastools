...
class Config(object):
    ...
    def __init__(self):
        self._config_path = os.environ.get('NASTOOL_CONFIG') if os.environ.get('NASTOOL_CONFIG') else r'C:\Users\97251\OneDrive\codes\python\SGDOWNLOADER\Nastools\config\config.yaml'
